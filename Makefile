...
all: rocksdb_delete_range rocksdb_filter rocksdb_singledelete rocksdb_ingest rocksdb_transaction sst_file_checker
...
clean:
	rm -rf rocksdb_delete_range rocksdb_filter rocksdb_singledelete rocksdb_ingest rocksdb_transaction sst_file_checker
